...
const add = (req, res)=>{
    ...
    res.render("add", {
        pageTitle:"Add User - Customer App",
        userTypes
    })
}
...
module.exports = { editUser, home, add, single, addLogicGet, delUser, addPostMethod, addPostMethodLogic , editUserLogic ,transUser ,transUserLogic}